        ...
        */
        ...
        if (grp != null) 
        {
            ...
            if(draftStage == 2) {
                ...
                // They actually go to 7 in pro captain's mode now
                ...
                for(int i = 0; i < draftHeroes.length; i++) {
                    ...
                    System.out.println("\nProcessing draft");
                    System.out.println(draftHeroes[i].toString());
                    ...
                    if(draftHeroes[i] > 0 && draftOrderProcessed[i] ==  false) {
                        ...
                        order = order + 1;
                        draftTimingsEntry.pick = i < 14 ? false : true;
                        ...
                        if (i == 11 || i == 17 || i == 23) {
                            if (draftTimingsEntry.draft_active_team == 2) {
                                draftTimingsEntry.draft_active_team = 3;
                            }
                            else {
                                draftTimingsEntry.draft_active_team = 2;
                            }
                        }
